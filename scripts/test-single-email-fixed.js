...
async function sendTestEmail() {
  ...
  try {
    ...
    console.log('\n💡 Possible solutions:');
    console.log('   1. Check SMTP server settings');
    console.log('   2. Verify email/password credentials');
    console.log('   3. Check if your hosting provider allows SMTP');
    console.log('   4. Try different port (465 with secure: true)');
  }
}

console.log('🚀 Class Booking System - Test Email Sender (FIXED VERSION)');
