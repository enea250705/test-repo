...
export async function POST(
  ...
  try {
    ...
    const daysRemaining = packageEndDate ? calculateDaysRemaining(packageEndDate) : 0;
    ...
    // Record that a reminder was sent (non-fatal if this fails)
    try {
      ...
      console.error("Failed to record reminder notification:", notificationError);
    }
